...
class TestFetchSp500Symbols(unittest.TestCase):
    ...
    def test_returns_list_of_symbols(self, mock_html):
        ...
        from src.services.watchlist_manager import fetch_sp500_symbols
...
class TestFetchNikkei225Symbols(unittest.TestCase):
    ...
    def test_returns_list_of_symbols(self, mock_html):
        ...
        from src.services.watchlist_manager import fetch_nikkei225_symbols
...
class TestFetchIndexSymbols(unittest.TestCase):
    ...
    @patch("src.services.watchlist_manager.fetch_sp500_symbols")
    def test_us_market_calls_sp500(self, mock_sp500):
        """us マーケット指定で fetch_sp500_symbols が呼ばれること"""
        from src.services.watchlist_manager import fetch_index_symbols
    ...
    @patch("src.services.watchlist_manager.fetch_nikkei225_symbols")
...
class TestVerifySymbolActive(unittest.TestCase):
    ...
    def test_active_symbol_returns_true(self, mock_ticker_cls):
        """有効な銘柄で True が返ること"""
        from src.services.watchlist_manager import verify_symbol_active
...
class TestDiffWatchlist(unittest.TestCase):
    ...
    @patch("src.services.watchlist_manager.verify_symbol_active")
    def test_new_symbols_are_added(self, mock_verify):
        """新規銘柄が added に追加されること"""
        from src.services.watchlist_manager import diff_watchlist
