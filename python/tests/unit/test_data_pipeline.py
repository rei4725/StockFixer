...
class TestFetchStockDataWithFeatures(_TmpDbTestCase):
    ...
    @patch("src.services.data_pipeline.save_raw_ohlcv")
    @patch("src.services.data_pipeline.get_stock_data")
    @patch("src.services.data_pipeline.should_fetch_fresh_data")
    @patch("src.services.data_pipeline.get_raw_ohlcv_from_db")
